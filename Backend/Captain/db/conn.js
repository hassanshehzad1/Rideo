...
const connect = async () => {
    try {
        ...
        console.log("Captain Service DB connected");
    } catch (err) {
        console.error("Captain Service DB connection failed:", err.message);
        console.log("Retrying Captain Service DB connection in 5 seconds...");
