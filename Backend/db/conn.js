...
const connect = async () => {
    try {
        ...
        console.log("Main Server DB connected");
    } catch (err) {
        console.error("Main Server DB connection failed:", err.message);
        console.log("Retrying Main Server DB connection in 5 seconds...");
