...
const connect = async () => {
    try {
        ...
        console.log("Ride Service DB connected");
    } catch (err) {
        console.error("Ride Service DB connection failed:", err.message);
        console.log("Retrying Ride Service DB connection in 5 seconds...");
